...
| [`08-multiplexer-architecture.mmd`](./08-multiplexer-architecture.mmd) | Four-level nested multiplexer — fan-in (Bridge), fan-out (Orchestrator), tool mux (MCP Gateway), input demux (Skills) | [`08-multiplexer-architecture.png`](../images/08-multiplexer-architecture.png) |
